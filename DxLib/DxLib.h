...
// ＤＸライブラリのバージョン
#define DXLIB_VERSION 0x310c
#define DXLIB_VERSION_STR _T( "3.10c" )
...
// ######## 06/17 ########
extern	int			SetDrawBright2(DWORD Bright ) ;				// 描画輝度を設定する
// ######## 06/17 ########
extern	int			ResetDrawBright(); // 描画輝度を元に戻す
// ######## 06/18 ########
extern	int			ResetDrawARGB(); // 描画の状態を元に戻す
// ######## 06/18 ########
extern	int			SetDrawARGB(DWORD argb, int blendmode); // 描画の輝度、アルファ値、ブレンドモードをセットする
