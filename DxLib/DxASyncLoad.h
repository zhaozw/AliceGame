...
extern	void	AddASyncLoadParamStruct( BYTE *Data, int *Addr, void *Param, int Size ) ;			// 非同期読み込みデータのパラメータに構造体パラメータを追加
extern	void	AddASyncLoadParamVoidP( BYTE *Data, int *Addr, void *Param ) ;						// 非同期読み込みデータのパラメータに void 型ポインタのパラメータを追加
