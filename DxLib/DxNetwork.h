...
extern	int			NetWorkSend_UseGParam( int NetHandle, void *Buffer, int Length, int ASyncLoadFlag = FALSE ) ;				// NetWorkSend のグローバルデータにアクセスしないバージョン
...
extern	int			NetWorkSendUDP_UseGParam( int NetUDPHandle, IPDATA SendIP_IPv4, IPDATA_IPv6 SendIP_IPv6, int SendPort, void *Buffer, int Length, int ASyncLoadFlag = FALSE ) ;	// NetWorkSendUDP のグローバルデータにアクセスしないバージョン
