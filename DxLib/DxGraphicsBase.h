...
extern	int		CreateGraphFromMem_UseGParam(           LOADGRAPH_GPARAM *GParam, int ReCreateFlag, int GrHandle, void *MemImage, int MemImageSize, void *AlphaImage = NULL, int AlphaImageSize = 0, int TextureFlag = TRUE, int ReverseFlag = FALSE, int ASyncLoadFlag = FALSE ) ;											// CreateGraphFromMem のグローバル変数にアクセスしないバージョン
extern	int		CreateDivGraphFromMem_UseGParam(        LOADGRAPH_GPARAM *GParam, int ReCreateFlag, void *MemImage, int MemImageSize, int AllNum, int XNum, int YNum, int SizeX, int SizeY, int *HandleBuf,int TextureFlag, int ReverseFlag, void *AlphaImage, int AlphaImageSize, int ASyncLoadFlag = FALSE ) ;			// CreateDivGraphFromMem のグローバル変数にアクセスしないバージョン
...
extern	int		CreateDivGraphFromBmp_UseGParam(        LOADGRAPH_GPARAM *GParam, int ReCreateFlag, BITMAPINFO *BmpInfo, void *GraphData, int AllNum, int XNum, int YNum, int SizeX, int SizeY, int *HandleBuf,int TextureFlag, int ReverseFlag, BITMAPINFO *AlphaInfo, void *AlphaData, int ASyncLoadFlag = FALSE ) ;		// CreateDivGraphFromBmp のグローバル変数にアクセスしないバージョン
extern	int		CreateGraphFromGraphImage_UseGParam(    LOADGRAPH_GPARAM *GParam, int ReCreateFlag, int GrHandle, BASEIMAGE *Image, BASEIMAGE *AlphaImage, int TextureFlag = TRUE , int ReverseFlag = FALSE, int ASyncLoadFlag = FALSE, int ASyncThread = FALSE ) ;												// CreateGraphFromGraphImage のグローバル変数にアクセスしないバージョン
...
extern	int		CreateGraphFromGraphImageBase_UseGParam( CREATE_GRAPHHANDLE_AND_BLTGRAPHIMAGE_GPARAM *GParam, int ReCreateFlag, int GrHandle, BASEIMAGE *Image, BASEIMAGE *AlphaImage, int TextureFlag, int ASyncThread = FALSE ) ;																									// CreateGraphFromGraphImageBase のグローバル変数にアクセスしないバージョン
...
extern	int		CreateGraphFromGraphImageBase( BASEIMAGE *Image, BASEIMAGE *AlphaImage, int TextureFlag ) ;																														// CreateGraphFromGraphImage の内部関数
extern	int		CreateDivGraphFromGraphImageBase( BASEIMAGE *Image, BASEIMAGE *AlphaImage, int AllNum, int XNum, int YNum, int SizeX, int SizeY, int *HandleBuf, int TextureFlag, int ReverseFlag ) ;							// CreateDivGraphFromGraphImage の内部関数
extern	int		ReCreateGraphFromGraphImageBase( BASEIMAGE *Image, BASEIMAGE *AlphaImage, int GrHandle, int TextureFlag ) ;																										// ReCreateGraphFromGraphImage の内部関数
extern	int		ReCreateDivGraphFromGraphImageBase( BASEIMAGE *Image, BASEIMAGE *AlphaImage, int AllNum, int XNum, int YNum, int SizeX, int SizeY, int *HandleBuf, int TextureFlag , int ReverseFlag ) ;						// ReCreateDivGraphFromGraphImage の内部関数
